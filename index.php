<?php 
// Load Files
require dirname(__FILE__) . '/functions/config.php';
require dirname(__FILE__) . '/functions/sql-query-builder.php';

// Run DB to see if its running 
// $db = new Database();
// $sql = new SQL();
// $sql_query = $sql->sql_query("SELECT","users","*");
// $data = $db->db_query($sql_query);
?>
                        ...
                        <div class="slider_area swiper-wrapper">
                            <div class="single_slider swiper-slide d-flex align-items-center" data-bgimg="assets/img/slider/slider1.jpg">
                                <div class="slider_content">
                                    ...
                                    <h1>summer <br> collection 2020</h1>
...
<!-- Mirrored from demo.hasthemes.com/antomi-preview/antomi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 May 2020 08:36:54 GMT -->
</html>
